...
INCLUDEPATH += "$${HOMEDIR}/Projects/platformio/df_clock/include"
INCLUDEPATH += "$${HOMEDIR}/Projects/platformio/df_clock/src"
INCLUDEPATH += "$${HOMEDIR}/Projects/platformio/df_clock/.pio/libdeps/lolin32_lite/DFRobotDFPlayerMini"
...
INCLUDEPATH += "$${HOMEDIR}/.platformio/packages/framework-arduinoespressif32/variants/lolin32-lite"
INCLUDEPATH += "$${HOMEDIR}/.platformio/lib/FastLED/src"
INCLUDEPATH += "$${HOMEDIR}/.platformio/lib/rdm6300/src"
...
DEFINES += "ARDUINO_VARIANT=&quot;lolin32-lite&quot;"
DEFINES += "ARDUINO_BOARD=&quot;WEMOS LOLIN32 Lite&quot;"
